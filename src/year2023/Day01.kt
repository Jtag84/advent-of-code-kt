...
val day: LocalDate = LocalDate.of(2023, DECEMBER, 1)
...
//    "Part 1 test: $part1TestAnswer".println()
//    check(part1TestAnswer == 142)

    "part 1: ${part1(input)}".println()


    val part2TestAnswer = part2(testInput)
    part2TestAnswer.println()
    check(part2TestAnswer == 281)
